...
| 最终 UI | 策划、程序标题 24px 加粗；人员、晨会内容、操作三个区域，右侧重新保存/删除并排；内容框默认一行，行距 4px |
| 当前布局 | v6 已真实 MEETING_RESUMED / LAYOUT_UPDATED / MEETING_READY，保持最近原消息及两行记录；User 取消补发，本次未发新消息 |

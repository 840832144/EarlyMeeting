...
| 最终 UI | 策划、程序标题 24px 加粗，两列与各区加号保留；新增删除本人行，删除成功后可换区重新添加 |
| 当前布局 | v5 已真实 MEETING_RESUMED / LAYOUT_UPDATED / MEETING_READY，保持原消息及两行已保存记录；未代用户点击删除 |
...
| 实测边界 | 当前已有卡片未重复发送；尚未到下一次 10:00，多群正式发送与删除回调未冒称实测通过 |

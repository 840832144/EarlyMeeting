...
更新时间：2026-09-08。TASK-0028 / EARLYMEETING；按 User 要求，正式群2恢复为与群1一致的规则：预填关闭，仅本人提交/删除。现有卡片保留，Task Review，不标记 Done。
...
| 当前布局 | v11 三个同级区域：策划、程序、今日交付；今日三群原消息均恢复，行数分别1/8/6 |
...
| 实测边界 | 2026-09-08 HTTP101 / CONNECTED、groups=3 scheduled=3 time=09:45；三群 prefill=false / owner / owner；MEETING_RESUMED rows=1/8/6，未重新发卡或模拟操作 |

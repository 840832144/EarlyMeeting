...
const NETWORK_CODES = new Set([
  ...
  'ECONNABORTED', 'ENETUNREACH', 'EHOSTUNREACH', 'EPIPE', 'EACCES', 'EPERM',
...
async function run() {
  ...
  output('[PROBE_VERSION] 0.1.1；仅改进连接诊断，不保存、不更新、不定时发送。');
...
module.exports = {readConfig, callbackHandler, safeLogger, safeErrorCode, errorFacts, diagnosis, diagnosticHttp};
